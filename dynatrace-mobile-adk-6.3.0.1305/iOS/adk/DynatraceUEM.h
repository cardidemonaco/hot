 ...
 */
+ (NULLABLE UEMAction *)enterActionWithName:(NONNULL NSString *)actionName NS_RETURNS_RETAINED;
...
+ (NULLABLE UEMAction *)enterActionWithName:(NONNULL NSString *)actionName
                               parentAction:(NULLABLE UEMAction *)parentAction NS_RETURNS_RETAINED;
...
+ (CPWR_StatusCode)startupWithApplicationName:(NONNULL NSString *)applicationName
                                    serverURL:(NONNULL NSString *)serverURL
                  authenticationClassDelegate:(NONNULL Class)callbackDelegate;
